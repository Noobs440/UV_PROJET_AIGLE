...
{ path: 'adminsys', component: AdminsysComponent },
  ...
  },
  {
    ...
    children: [
      ...
      // {path:"home/register", component:RegisterComponent},
      // {path:"admin", component:AdminDashboardComponent},
      {path:"homec/contact", component:ContactComponent},
      {path:"homec/category", component:PopCategoryComponent},
      {path:"homec/projects-listing", component:ProjectsComponent},
      {path:"homec/team", component:TeamComponent},
      {path:"homec/recent-post", component:RecentPostComponent},
      {path:"homec/project-detail/:id", component:ProjectDetailComponent},
      {path:"homec",component:HomeComponent},
      //{path:"homec",component:HomeComponentConn},
    ],
     //canActivate: [appGuard]
  },
  {
